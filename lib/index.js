...
import styles, { buttonClose, durationText, renderClose, renderDone,renderChange } from './style';
      ...
      <Modal visible={isOpen} transparent animationType="fade"
        ...
        <View style={styles.modal}>
          ...
          <View style={styles.container}>
            ...
            <TouchableOpacity onPress={this.toggleCamera} style={styles.backFront}>
              {renderChange()}
            </TouchableOpacity>
          </View>
        </View>
